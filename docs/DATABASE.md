...
| 0254 | **온보딩 얼굴형 태그 5종**(2단계 #4). FACE_SHAPES(달걀형/땅콩형/장방형/각진형/둥근형) onboarding='얼굴형'·category='미지정' 적재(en=oval/peanut/oblong/square/round). 백업 `tag_dictionary_bak_0254`(2117). 검증: 적재 5·기존 onboarding(피부고민11·관심시술7·피부타입4) 유지. | **적용 완료 (2026-06-06)** |

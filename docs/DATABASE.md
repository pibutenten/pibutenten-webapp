...
- 관심(Q&A) 알림 토대(0244 — 4-2/3b-1): `profiles.interested_procedures`·`skin_concerns` GIN 인덱스(태그 overlap digest 대비), `cards.keywords` GIN 은 기존. **생산자(트리거/cron)는 3b-2** — 현재 keyword 알림 0건.

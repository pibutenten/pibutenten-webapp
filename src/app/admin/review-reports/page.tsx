...
import BetaAdminReviewReportsView, {
  type BetaReviewOverviewRow,
} from "./BetaAdminReviewReportsView";
...
/**
 * /admin/review-reports — 운영자 전용 '시술 리포트' 요약 표 (읽기 전용, 베타 셸 적용 Phase 3 ②).
 *
 ...
 *
 * 원칙: 가드·RPC·그룹핑은 운영 그대로 유지하고, 렌더만 BetaAdminReviewReportsView(베타 셸 래퍼)로 위임한다.
 */

type OverviewRow = BetaReviewOverviewRow;

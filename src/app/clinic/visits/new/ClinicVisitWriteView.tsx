  ...
  return (
    <ClinicShell back="/clinic">
      <section className="mx-auto w-full max-w-[680px] py-6">
        <h1 className="mb-1 text-[20px] font-bold text-[var(--text)]">시술노트 작성</h1>
          ...
          {activePatients.length === 0 ? (
            <div className="py-4 text-center">
              ...
              <Link
                ...
                className="mt-3 inline-flex rounded-full bg-[var(--primary)] px-4 py-2 text-[13px] font-semibold text-white"
              >
                + 환자 등록
              </Link>
            </div>

/**
 * Fitzpatrick 피부톤 6단계 — UI 표시 SSOT (원장 확정 2026-07-03, 색상 v2 조정 동일자).
 *
 ...
 * 톤 hex·이름·캡션을 바꿀 때는 이 파일만 수정한다(화면 하드코딩 금지).
 */
export const FITZPATRICK_TONES = [
  { v: 1, tone: "#FDF0E6", caption: "북유럽·켈트계 매우 흰 피부" },
  { v: 2, tone: "#F9E6D6", caption: "밝은 한국인 피부" },
  { v: 3, tone: "#F1D6B8", caption: "보통 한국인 피부" },
  { v: 4, tone: "#D2AC82", caption: "어두운 편 한국인 피부" },
